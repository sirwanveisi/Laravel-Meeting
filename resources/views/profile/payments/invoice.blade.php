            ...
            <div class="col-md-12 col-lg-10 col-xl-9">
                ...
                <div class="bg-base-0 border rounded p-5 my-3 position-relative overflow-hidden">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6"><h3 class="text-uppercase text-muted">{{ __('Invoice') }}</h3></div>
                        ...
                        <div class="col-12">
                            <div class="list-group list-group-flush">
                                ...
                                @if ($payment->coupon || $payment->tax_rates)
                                    <div class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-9">{{ __('Subtotal') }}</div>
                                ...
                                @foreach(collect($payment->tax_rates) as $taxRate)
                                    <div class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-9">{{ $taxRate->name }} ({{ $taxRate->percentage }}% {{ $taxRate->type ? __('excl.') : __('incl.') }})</div>
                                ...
                                <div class="list-group-item px-0">
                                    <div class="row">
                                        <div class="col-9 font-weight-bold">{{ __('Total') }}</div>
