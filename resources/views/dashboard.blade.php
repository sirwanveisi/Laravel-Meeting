        ...
        <div class="row mb-2">
            <div class="col-lg-3 col-sm-5 col-md-4 col-xl-3 col-12 mb-3">
                <div class="col-12 col-xl-12 col-md-12 col-sm-12" style="padding: 0;">
                    <button class="btn btn-primary btn-block shadow-sm" data-toggle="modal" data-target="#createMeeting"><i
                            class="fa fa-plus-circle mr-3" aria-hidden="true"></i> {{ __('Create Meeting') }}</button>
                </div>
            </div>
            <div class="col-lg-9 col-sm-7 col-md-8 col-xl-9 col-12 p-0">
                <form id="meetingDashboard">
                    <div class="input-group mb-3 col-sm-10 col-md-7 col-lg-4 col-xl-3 col-12 float-right">
                        <input type="text" class="form-control" name="id" placeholder="{{ __('Enter Meeting ID') }}"
        ...
        <div class="row">
                            ...
                            @if ($firstMeeting)
                                @foreach ($meetings as $key => $value)
                                    <div class="card w-100 mb-2 mt-1 pr-4 meeting-card"
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title meeting-title font-weight-bold mb-3"><?= $value->title ?>
                                            </h5>
            ...
            <div class="col-lg-9 col-xl-9 col-md-8 col-sm-7">
                <div id="meetingDetail" class="card w-100" @if (!$firstMeeting) hidden @endif>
                    <div class="card-header">
                        <h5 class="mb-0" id="meetingTitleDetail"><?= $firstMeeting ? $firstMeeting->title : '' ?>
                        </h5>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        <form id="meetingsForm">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-primary" id="save">{{ __('Save') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form id="inviteForm">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <input type="email" id="inviteEmail" class="form-control mb-2 mr-sm-2" name="email"
                                        placeholder="{{ __('Enter an email') }}" maxlength="50" required />
                                </div>
